...
const required = [
  ...
  "public/skills/emailcampaignskill/SKILL.md",
  "public/.well-known/skills/emailcampaignskill/SKILL.md",
  "public/.well-known/agent-skills/emailcampaignskill/SKILL.md",
...
if (!markdown.includes("npx skills add emailcampaignskill")) throw new Error("Missing markdown install shortcut");
...
if (indexJson.skills?.[0]?.name !== "emailcampaignskill") throw new Error("Invalid well-known skills index");
